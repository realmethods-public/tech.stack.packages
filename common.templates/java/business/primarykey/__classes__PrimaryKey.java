...
#set( $pk = ${classObject.getFirstPrimaryKey()} )		    
    public ${classObject.getName()}PrimaryKey( Object ${pk.getAsArgument()} ) 
    {
    	this.${pk.getAsArgument()} = ${pk.getAsArgument()} != null ? new ${pk.getType()}( ${pk.getAsArgument()}.toString() ) : null;
    }    

#if ( $classObject.hasSimplePrimaryKey() == false )
    /** 
